    ...
    <section className="relative py-24">
      <div className="mx-auto max-w-7xl px-[32px]">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {FEATURES.map((feature, index) => {
            ...
            return (
              <div 
                key={index}
                className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-8 text-center"
              >
                <div className="flex flex-col items-center">
                  <div className="w-20 h-20 bg-yellow-500/20 border-2 border-yellow-500 rounded-full flex items-center justify-center mb-6">
        ...
        <div className="text-center">
          <Link 
            href="/playground" 
            className="inline-flex items-center justify-center px-12 py-4 text-xl font-medium text-black bg-yellow-500 rounded-lg hover:bg-yellow-400 transition-colors"
          >
            Try For Free Now
          </Link>
